---
description: Show session-restore phase status and next-up phase
---

Read `docs/SESSION_RESTORE.md` and locate the **Phase Index** table.
...
4. A one-line recommendation: "next step is `/session-phase <N>`" or, if a phase is 🟡 in-progress, "resume in-progress phase N".
