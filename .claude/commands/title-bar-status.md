---
description: Show custom-title-bar phase status and next-up phase
---

Read `docs/TITLE_BAR.md` and locate the **Phase Index** table.
...
4. A one-line recommendation: "next step is `/title-bar-phase <N>`" or, if a phase is 🟡 in-progress, "resume in-progress phase N".
