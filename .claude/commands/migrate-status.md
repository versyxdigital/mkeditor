---
description: Show React migration phase status and next-up phase
---
...
4. A one-line recommendation: "next step is `/migrate-phase <N>`" or, if a phase is 🟡 in-progress, "resume in-progress phase N".
